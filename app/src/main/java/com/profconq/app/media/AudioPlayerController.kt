...
class AudioPlayerController {
    ...
    private var segmentEndMs: Int? = null
    ...
    fun playSegment(startMs: Int, endMs: Int) {
        val player = mediaPlayer ?: return
        val start = startMs.coerceIn(0, durationMs.coerceAtLeast(0))
        val end = endMs.coerceIn(start, durationMs.coerceAtLeast(0))
        segmentEndMs = end
        player.seekTo(start)
        positionMs = start
        player.start()
